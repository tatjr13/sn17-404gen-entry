export default function generate(THREE) {
  ...
  const hingeGeo = new THREE.CylinderGeometry(0.02, 0.02, 0.1, 16);
  ...
  // Decorative bands
  const bandGeo = new THREE.TorusGeometry(0.33, 0.005, 8, 32);
  ...
  // Spout
  const spoutGeo = new THREE.CylinderGeometry(0.03, 0.05, 0.15, 16);
